...
theme_path = "/home/david/.config/awesome/default"
...
apptags =
{
    ...
    -- ["mocp"] = { screen = 2, tag = 4 },
    ["Thunderbird-bin"] = { screen = 1, tag = 2 },
    ["pidgin"] = { screen = 1, tag = 3 },
    ["amarokapp"] = { screen = 1, tag = 4 },
...
--  tags[s][1].selected = true
    tags[s][1] = tag({ name = "web", layout = "max" })
    tags[s][1].screen = s
    tags[s][2] = tag({ name = "email", layout = "max" })
    tags[s][2].screen = s
    tags[s][3] = tag({ name = "im", layout = "floating" })
    tags[s][3].screen = s
    tags[s][4] = tag({ name = "music", layout = "max" })
    tags[s][4].screen = s
    tags[s][5] = tag({ name = "vmware", layout = "tile" })
    tags[s][5].screen = s
    tags[s][6] = tag({ name = "6", layout = "tile" })
    tags[s][6].screen = s
    tags[s][1].selected = true
end
-- }}}
...
mylauncher = awful.widget.launcher({ name = "mylauncher",
                                     image = "/home/david/awesome/awesome/icons/awesome16.png",
...
for s = 1, screen.count() do
    ...
    mylayoutbox[s].image = image("/home/david/awesome/awesome/icons/layouts/tilew.png")
end
...
keybinding({ "Mod1" }, "space", function () awful.spawn("$(dmenu_path | dmenu -b -nb '#535d6c' -sb '#222222' -sf '#FFFFFF')") end):add()
-- }}}
...
awful.hooks.arrange.register(function (screen)
    ...
    if layout then
        mylayoutbox[screen].image = image("/home/david/awesome/awesome/icons/layouts/" .. layout .. "w.png")
    else
